  ...
  return (
    <>
      <header style={{
        ...
        <a
          href="#"
          onClick={(e) => { e.preventDefault(); setResumePopup(true) }}
      ...
      <div style={{
        ...
        {LINKS.map((l, i) => (
          <a
            ...
            style={{
              fontFamily: 'Cormorant Garamond', fontSize: '2.4rem',
              color: active === l.href.slice(1) ? 'var(--accent)' : 'rgba(255,255,255,0.85)',
        ...
        <a
          href="#"
          onClick={(e) => { e.preventDefault(); setResumePopup(true); setMenuOpen(false) }}
        ...
        >
          ...
          >
            ...
            <p style={{ fontFamily: 'DM Mono', fontSize: '0.78rem', color: 'rgba(255,255,255,0.55)', lineHeight: 1.8, marginBottom: 28 }}>
              Download my CV or get in touch to discuss opportunities.
            </p>

            <a
              href="/CV_HARRABI_ALAA.pdf"
              download="CV_Alaa_Harrabi.pdf"
              onClick={() => setResumePopup(false)}
              style={{
            ...
            <a
              ...
              style={{
                ...
                borderRadius: 8, fontFamily: 'DM Mono', fontSize: '0.75rem',
                color: 'rgba(255,213,128,0.8)', textDecoration: 'none',
